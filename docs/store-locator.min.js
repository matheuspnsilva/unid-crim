...
*/
    ...
    storeLocator.GMEDataFeed = function(a) {
        ...
        this.apiKey_ = AIzaSyDNg8w3S8X5z2C0Q2C1yr5W3R00naKX7KQ /*a.apiKey;*/
    ...
    storeLocator.Panel = function(a, b) {
        ...
        this.settings_ = $.extend({
            locationSearch: !0,
            locationSearchLabel: "Local de destino:",
            featureFilter: !0,
            directions: !0,
            view: null
        }, b);
    ...
    ;
    storeLocator.Panel.NO_STORES_HTML_ = '\x3cli class\x3d"no-stores"\x3eNão há unidades nesta área.\x3c/li\x3e';
    storeLocator.Panel.NO_STORES_IN_VIEW_HTML_ = '\x3cli class\x3d"no-stores"\x3eNão há unidades nesta área. As unidades mais próximas são listadas abaixo.\x3c/li\x3e';
    ...
    ;
    storeLocator.Panel.prototype.selectedStore_changed = function() { 	/* Evento do painel lateral: mudança, unidade selecionada */
        ...
        if (b) {
            ...
            var c = a.get("view").getInfoWindow().getContent()
              , d = $("\x3ca/\x3e").text("Rotas").attr("href", "#").addClass("action").addClass("directions")
              , e = $("\x3ca/\x3e").text("Zoom aqui").attr("href", "#").addClass("action").addClass("zoomhere")
...
/*                destination: this.directionsTo_.getLocation(),	*/
                origin: this.directionsTo_.getLocation(),				
                destination: this.directionsFrom_,	
